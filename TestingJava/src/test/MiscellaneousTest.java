...
public class MiscellaneousTest {
    ...
    public void timeOutReverseStringTest() {
        assertTimeout(Duration.ofMillis(1), () -> ReverseString.reverseString("Hello world, it is me again"),
                () -> "Reverse String Performance test Failed");
    }

    @Test
    public void timeOutReverseString2Test() {
        assertTimeout(Duration.ofMillis(10), () -> ReverseString.reverseString2("Hello world, it is me again"),
                () -> "Reverse String (2) Performance test Failed");
    }
