...
public class ReverseStringTest {
    ...
    public void testReverseMultipleWords(){
        assertEquals("Reverse String Multiple Words Failed", ReverseString.reverseString("deliaF sdroW elpitluM gnirtS esreveR"), ()->"Reverse String Multiple Words Failed");
    }
    ...
    public void testReverseMultipleWords2(){
        assertEquals("Reverse String Multiple Words Failed", ReverseString.reverseString2("deliaF sdroW elpitluM gnirtS esreveR"), ()->"Reverse String (2) Multiple Words Failed");
    }
}
